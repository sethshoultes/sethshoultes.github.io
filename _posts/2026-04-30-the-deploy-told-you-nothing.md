...
date: 2026-04-30
categories: [engineering, discipline]
tags: [personas, infrastructure, automation]
image: /blog/images/the-deploy-told-you-nothing-featured.png
---
...
**References:**
- [Post-deploy: Verify the production domain](~/brain/learnings/post-deploy-verify-the-production-domain.md)
- [Cloudflare 525: Zone mismatch](~/brain/learnings/cloudflare-525-zone-mismatch.md)
- [Worker custom domains and zone account matching](~/brain/learnings/cloudflare-worker-custom-domain-needs-zone-account-match.md)
- [Code review is not QA](~/brain/learnings/code-review-is-not-qa.md)
